...
│       ├── init-feature.md        <-- Compiled from qa-agent-os base install
│       └── create-ticket.md       <-- Compiled from qa-agent-os base install
│
├── qa-agent-os/
│   ├── product/
...
│           └── TWRR-123/
│               ├── planning/
│               │    └── requirements.md <-- Generated during /create-ticket (analise phase)
│               ├── artifacts/
│                   ├── csv.md         <-- Generated by /export-csv [optional]
│                   └── testcases.md   <-- Generated during /create-ticket (testcase phase)
│
└── src/
